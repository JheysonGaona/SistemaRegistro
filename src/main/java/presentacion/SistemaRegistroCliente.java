 ...
 */
public class SistemaRegistroCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblSystemUser.setText("SISTEMA DE REGISTRO DE CLIENTES");
        ...
        lblListUserRegister.setText("LISTA DE CLIENTES REGISTRADOS");
    ...
    private Cliente GenerarDatosCliente(){
        ...
        try {
            ...
            nuevoCliente = new Cliente(nombre, apellido, numId, correo,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaRegistroCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SistemaRegistroCliente().setVisible(true);
            }
        });
    }
